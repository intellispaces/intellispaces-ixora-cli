...
public interface Console extends Point {
  ...
  @Transition(value = "5c0ac95a-a8f9-4a77-a6f7-7897659e80b1", name = "ConsolePrintIntegerTransition", allowedTraverseTypes = TraverseTypes.Moving)
  Void print(int number);

  @Transition(value = "0df1747b-b0dc-4a34-9584-54d06af4ffe2", name = "ConsolePrintlnStringTransition", allowedTraverseTypes = TraverseTypes.Moving)
  Void println(String string);

  @Transition(value = "1e2ffbd9-dd81-4fa5-8658-93052623c1b9", name = "ConsolePrintlnIntegerTransition", allowedTraverseTypes = TraverseTypes.Moving)
